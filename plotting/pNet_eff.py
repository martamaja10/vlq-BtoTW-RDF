...
indir = "/store/user/sxiaohe/vlq-BtoTW-RDF/cut_update1_170/Bprime_hadds_alt/"
...
hn = TH2F("hn", "Normalization factor", 3, 0, 3, 3, 0, 3)
gStyle.SetOptStat(11);

tfile = TFile.Open("root://cmseos.fnal.gov/"+indir+"/"+samples[sys.argv[1]], "READ")
...
h.Divide(hn)
h.Draw("COLZ TEXT")
outputName = outdir+"confusionMatrix_"+sys.argv[1]
